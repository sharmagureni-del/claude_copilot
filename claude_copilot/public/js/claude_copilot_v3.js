 ...
 *
 * v3 (2026-07-30): the "Aarya" rename in v2 never actually took effect on
 * the live site because that fix was uploaded to the wrong nested path in
 * the GitHub repo (claude_copilot/claude_copilot/... instead of the real
 * package path claude_copilot/...), so Frappe was always building from the
 * original, unfixed hooks.py/JS. This v3 file (and the accompanying
 * hooks.py edit) are uploaded to the CORRECT path this time. Renamed again
 * (v2 -> v3) purely to guarantee a brand-new, never-before-cached asset
 * URL, since /assets/ is served with a 1-year immutable cache header.
 */
(function () {
  "use strict";
