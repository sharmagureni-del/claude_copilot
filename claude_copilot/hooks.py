...
app_description = "In-app Aarya assistant that guides users through the correct ERPNext process on every screen."
...
app_include_js = "/assets/claude_copilot/js/claude_copilot_v3.js"
